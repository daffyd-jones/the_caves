            ...
            let (symbol, color) = {
                    ...
                    && (ani_parts.1 .1..ani_parts.2.len()).contains(&jy)
                {
                    ...
                    match item {
                        ...
                        ShopItem::Hermit(item) => item.icon,
                        ShopItem::Guild => todo!(),
                    ...
                    match cell {
                        ...
                        Cells::Tile1 => ('▧', Color::Magenta),
                        Cells::Tile2 => ('▨', Color::Cyan),
                        Cells::Tile3 => ('▩', Color::Blue),
                        ...
                        Cells::ChairRight1 => ('Һ', Color::DarkGray),
                        Cells::ChairRight2 => ('Ⴙ', Color::DarkGray),
                        Cells::Firewood => ('ж', Color::Red),
                        Cells::FireSmoke => ('ঌ', Color::Red),
                        Cells::FireDiamond => ('܀', Color::Yellow),
                        Cells::FireTri => ('ஃ', Color::Blue),
                        Cells::Stand1 => ('Ŧ', Color::Gray),
                        Cells::Stand2 => ('Ÿ', Color::Gray),
                        Cells::Stand3 => ('Ť', Color::Gray),
                        Cells::StandBL => ('ƃ', Color::Gray),
                        Cells::StandDL => ('ƌ', Color::Gray),
                        Cells::StandBS => ('Ƃ', Color::Gray),
                        Cells::StandDS => ('Ƌ', Color::Gray),
                        Cells::CircleVL => ('◍', Color::LightBlue),
                        Cells::CircleHex => ('⏣', Color::LightMagenta),
                        Cells::CircleC => ('⌬', Color::LightCyan),
                        Cells::Drawers => ('⌹', Color::DarkGray),
                        Cells::Shelves => ('⌸', Color::DarkGray),
                        Cells::Vase => ('⚱', Color::Gray),
                        Cells::LadderV => ('𜲄', Color::Gray),
                        Cells::LadderH => ('𜲅', Color::Gray),
                        Cells::TickV => ('𜲐', Color::Gray),
                        Cells::TickH => ('𜲑', Color::Gray),
                        Cells::Tech1 => ('ቋ', Color::Gray),
                        Cells::Tech2 => ('🝻', Color::Gray),
                        Cells::Tech3 => ('🜟', Color::Gray),
                        Cells::Tech4 => ('ଏ', Color::DarkGray),
                        Cells::Tech5 => ('Ҧ', Color::DarkGray),
                        Cells::Tech6 => ('Ҹ', Color::DarkGray),
                        Cells::Tech7 => ('Ҵ', Color::DarkGray),
                        Cells::Tech8 => ('ౝ', Color::DarkGray),
                        Cells::Tech9 => ('𜰔', Color::DarkGray),
                        Cells::Tech10 => ('𜰓', Color::DarkGray),
                        Cells::Tech11 => ('𜰉', Color::DarkGray),
                        Cells::Tech12 => ('𜰊', Color::DarkGray),
                        Cells::Tech13 => ('⛀', Color::Gray),
                        Cells::Tech14 => ('⛁', Color::Gray),
                        Cells::Tech15 => ('⛂', Color::Gray),
                        ...
                        Cells::OldWall4 => ('ቩ', Color::Gray),
                        Cells::OldWall5 => ('ቭ', Color::Gray),
                        Cells::CardTile1 => ('🀫', Color::Magenta),
                        Cells::CardTile2 => ('🀘', Color::Cyan),
                        Cells::CardTile3 => ('🀆', Color::Blue),
                        Cells::CardTile4 => ('🀙', Color::Red),
